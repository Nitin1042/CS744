...
After Login/Register we can proceed with our operation. We will have the following options available: LIST, READ, WRITE, DELETE, CHECKOUT, CREATE, COMMIT, EXIT.
...
This will create the test clients to put load on the server. It needs a number as an command line argument and created n test clients.
